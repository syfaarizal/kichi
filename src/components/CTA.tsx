...
export default function CTA() {
  return (
    <section id="cta" className="relative py-20 sm:py-28 text-center z-[1] overflow-hidden">
      <div
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[320px] h-[220px] sm:w-[600px] sm:h-[400px] rounded-full pointer-events-none"
        style={{
      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 relative z-[1]">
        <div className="reveal">
          ...
          <p className="text-slate-500 text-base sm:text-lg leading-relaxed max-w-[560px] mx-auto mb-10">
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-3 px-6 sm:px-10 py-4 rounded-2xl font-extrabold text-base sm:text-lg text-white no-underline transition-all duration-200 hover:-translate-y-0.5"
            style={{
          ...
          <div className="flex items-center gap-4 justify-center mt-12 px-4">
            <div
              className="h-px w-20"
              style={{
